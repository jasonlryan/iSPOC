...
export const contentPanels: Record<string, ContentPanel> = {
  ...
  disclaimer: {
    ...
    title: 'Disclaimer',
    content: [
      'This AI assistant is designed to provide general information and guidance. While we strive for accuracy, please verify critical information through official channels. For urgent matters, contact your supervisor or HR directly. Policies and associated documents will not be updated for the pilot, please continue to refer to policy updates on MHA Connect.'
    ],
    variant: 'highlight'
  }
};
...
export const starterQuestions: StarterQuestion[] = [
  {
    ...
    question: 'What are the key stages in MHA\'s recruitment process, and how does the organization ensure equality and diversity during hiring?'
  },
  {
  ...
  {
    title: '4. Whistleblowing Process Question',
    question: 'If I need to report a serious concern about misconduct, what protections does the Whistleblowing Policy provide and what steps should I follow?'
  },
  {
